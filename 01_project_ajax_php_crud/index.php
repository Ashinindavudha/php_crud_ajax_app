...
<head>
    ...
    <title>Server side ajax crud datatable wiht boostrap modal</title>
...
<body>
    <div class="content">
    <h1>Server side ajax crud datatable wiht boostrap modal</h1>
    ...
    <br>
    <div align="right">
    <button type="button" id="add_button" data-toggle
    ="modal" data-target="#userModal" class="btn btn-success btn-lg">Add Course</button>
    
    </div>
    </div>
    <div id="userModal" class="modal fade">
    <div class="modal-dialog">
    <form action="" method="post" enctype="multipart/form-data" id="course_form">
